...
>
	<div
		class="bg-mlb-white m-6 flex w-1/3 h-3/5 flex-col items-center justify-center rounded-xl p-5 drop-shadow-md"
	>
		...
		<button class="w-1/3 bg-mlb-orange/80 p-1 my-2 rounded-full hover:bg-mlb-orange" aria-label="status dropdown">
		</button>
